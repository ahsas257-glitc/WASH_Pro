...
# ============================================================
st.set_page_config(page_title="Tool 6 — WASH Report Generator", layout="wide")

# Robust project root: /pages/Tool_6.py -> project root is parents[1]
...
row = _load_tool6_row(GOOGLE_SHEET_ID, tool_name, str(tpm_id), TPM_COL)
if not row:
...
def _generate_docx() -> bool:
    ...
    if cover_bytes is None:
        st.session_state["tool6_docx_bytes"] = None
        return False
    ...
    severity_by_no = st.session_state.get("tool6_severity_by_no") or {}
    severity_by_finding = st.session_state.get("tool6_severity_by_finding") or {}
    ...
    st.session_state["tool6_docx_bytes"] = docx_bytes
    return True
...
if step == 8:
    ...
    payload = st.session_state.get("tool6_conclusion_payload") or {}
